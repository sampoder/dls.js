...
class DLS {
  ...
  getRevisedTarget(oversLost, firstInningsCutShort = false){
    if(firstInningsCutShort){
    ...
    return Math.ceil(((resourcesAtTheStart - resourcesLost) / resourcesAtTheStart) * this.firstTeamScore)
  }
}
